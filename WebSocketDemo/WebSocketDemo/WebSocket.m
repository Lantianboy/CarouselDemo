...
- (void)webSocketDidOpen:(SRWebSocket *)webSocket {
    ...
    //发送数据和参数
//    NSMutableArray * mut = [NSMutableArray arrayWithObject:@{@"stockID":@"1845456"}] ;
//    NSError * error ;
//    NSData * jsonData = [NSJSONSerialization dataWithJSONObject:@{@"ctn":@"WebSocket",@"mtn":@"chooseStock",@"data":mut} options:NSJSONWritingPrettyPrinted error:&error] ;
